...
{
    [DbContext(typeof(AutoFullDbContext))]
    [Migration("20241227041233_addedNewEntityAndChangedMarca")]
    partial class addedNewEntityAndChangedMarca
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AutoFull.Models.CartAuto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AutoFull.Models.MyUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AutoFull.Models.Auto", b =>
                {
                    ...
                    b.HasOne("AutoFull.Models.Order", null)
                        .WithMany("Autos")
            ...
            modelBuilder.Entity("AutoFull.Models.CartAuto", b =>
                {
                    b.HasOne("AutoFull.Models.Auto", "Auto")
                        .WithMany()
                        .HasForeignKey("AutoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AutoFull.Models.Cart", "Cart")
                        .WithMany("CartAutos")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("AutoFull.Models.MyUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
